const URL = "https://api.ngrok.com/endpoints";
const API_KEY = "2eu6oD1tcqWy6XR9q2L7dEOmzOj_2s5AgooezN2eZy1BaozMc";
const HEADERS = {
...
// Devuelve un array con los endpoints en formato JSON
export const ENDPOINTS = endpoints_array;
